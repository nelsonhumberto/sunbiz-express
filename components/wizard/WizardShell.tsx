...
import { TOTAL_STEPS, STEP_NAMES } from '@/lib/wizard-constants';
        ...
        <div className="container pb-4">
          <div className="flex items-center justify-between mb-2 text-xs">
            <span className="text-ink-muted font-medium">
              Step <span className="text-ink">{step}</span> of {TOTAL_STEPS} ·{' '}
              <span className="text-primary font-semibold">{stepInfo.title}</span>
            </span>
